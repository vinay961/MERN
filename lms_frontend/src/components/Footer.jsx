...
function Footer(){
    ...
    return(
        <>
            <footer className='relative bottom-0 left-0 h-[15vh] py-5 flex flex-col justify-center items-center bg-gray-800 text-white'>
                ...
                <p className='text-center'>© 2025 New LearningHub. All rights reserved.</p>
